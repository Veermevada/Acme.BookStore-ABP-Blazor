...
namespace Acme.BookStore.Blazor.Pages.TenantManagement;
...
public partial class CustomTenantManagement
{
    ...
    protected CustomFeatureManagementModal FeatureManagementModal;

    protected bool ShowPassword { get; set; }

    protected PageToolbar Toolbar { get; } = new();

    protected List<TableColumn> TenantManagementTableColumns => TableColumns.Get<CustomTenantManagement>();
    ...
    protected override ValueTask SetTableColumnsAsync()
    {
        TenantManagementTableColumns
            .AddRange(new TableColumn[]
            {
                    ...
                    {
                        Title = L["Actions"],
                        Actions = EntityActions.Get<CustomTenantManagement>(),
                    },
                    new TableColumn
                    {
                        Title = L["TenantName"],
                     ...
                     new() 
                     {
                        ...
                        Sortable = false,
                        Component = typeof(TwoFactorEnabledColumn)
                     }
            });
